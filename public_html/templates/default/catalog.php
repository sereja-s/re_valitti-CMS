			...
			<div class="about__body">
				<div class="about__header">
					<div data-fls-blockhead="" class="about__blockhead blockhead blockhead--left">
						<h1 class="blockhead__title">
							Услуги парикмахеров-стилистов для Леди
							<span></span>
						</h1>
						<div class="blockhead__text">
							<p>
								В центре используются красители премиальных марок KYDRA,
								LOREAL PROFESSIONNEL. Красители данных брендов отвечают нашим треб
								к цвету, качеству и безопасности. После окрашивания волосы равном
								наполняются пигментом, становятся гладкими и блестящими.
							</p>
						</div>
					</div>
				...
				<div class="about__main">
					<!-- <section data-fls-border="" class="about__content content-about">
						<div class="content-about__label">Arik Andersson</div>
						<h2 class="content-about__title">Your Partner in Bringing Your Web Design Vision to Life</h2>
						...
						<figure class="content-about__picture">
							<picture>
								...
								<img alt="Arik" class="content-about__image" src="<?= PATH . TEMPLATE ?>catalog/assets/img/about/Image.webp">
							</picture>
						</figure>
					</section>
